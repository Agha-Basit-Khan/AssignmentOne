...
public class FruitCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(FruitCategory.this,Category.class);
                startActivity(i);
            }
        });
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(FruitCategory.this,SelectedItem.class);
                startActivity(i);
            }
        });
    }
    public void show() {
        ...
        final Cursor c = db.rawQuery("select * from itemTable1 where description='Fruits'", null);
